...
angular.module('mean.users').factory('MeanUser', ['$rootScope', '$http', '$location', '$stateParams', '$cookies', '$q', '$timeout', '$cookieStore', '$log',
    function ($rootScope, $http, $location, $stateParams, $cookies, $q, $timeout, $cookieStore, $log) {
